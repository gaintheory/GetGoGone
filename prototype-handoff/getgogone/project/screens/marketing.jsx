      ...
      <div className="mkt-layout">
        ...
        <main className="mkt-compose">
          <div className="card">
            ...
            <div className="card-h" style={{ paddingBottom: 10 }}>
              ...
              <div className="row" style={{ gap: 6 }}>
                ...
                <Btn size="sm" variant="ghost" icon={Icon.Sparkles}>Rewrite with AI</Btn>
              </div>
            </div>

            <div className="card-b">
              {/* From */}
              <div className="mkt-from">
          ...
          <div className="card" style={{ marginTop: 14 }}>
            ...
            <div className="card-b">
              {channel === "sms" ? <SMSPreview text={sms}/> : <EmailPreview subject={subject} body={body}/>}
            </div>
          </div>
        </main>
...
function SMSPreview({ text }) {
  const rendered = previewTokens(text || "Your message will appear here.");
  return (
...
function EmailPreview({ subject, body }) {
  const subj = previewTokens(subject || "(no subject)");
  const bod = previewTokens(body || "Your email body will appear here.");
  return (
